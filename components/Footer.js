  ...
  return (
    <>
      <div className="w-full fixed bottom-0 left-0 flex justify-between items-center py-[19px] px-[25px] bg-[#F0F0F0] flex-wrap z-10 lg:bg-transparent lg:flex-row lg:items-end">
        <div className="min-[405px]:w-full min-[405px]:flex min-[405px]:justify-between min-[405px]:items-baseline lg:flex-col lg:gap-[9px] lg:w-1/2">
          <p className="text-nowrap !text-[10px] lg:!text-[13px] pb-[6px] lg:pb-0">
            +1 (801) 499 5045{" / "}
            <button
              className="!no-underline !text-[10px] lg:!text-[13px] hover:!text-blue"
              onClick={() => setOpen(!open)}
            >
              EMAIL
            </button>
          </p>
          <p className="text-end w-fit text-nowrap !text-[10px] lg:!text-[13px]">
